...
%%%%%%%%%%% Own packages
%\begin{•}
\usepackage[a4paper, vmargin=0.8in,hmargin=0.4in]{geometry}
\usepackage{multicol}
\usepackage{lipsum}
% Spacing
\linespread{0.9}
...
%\footnote{Four movies included in the delivery; sanity test \textit{sanity\_endtime\_60\_T.mp4}, basic perturbation \textit{basic\_endtime\_300\_T.mp4}, complex perturbation \textit{viz\_5\_blobs\_endtime\_450.mp4} and finally the horizontally averaged vertically energy flux in \textit{basic\_endtime\_300\_flux.mp4}.}
...
%
%Boundary conditions, lacking information. But good forced thinking!
%
%Stress tensor, so no turbulence.
%Internal friction.
%
%miss diffusion.
%
%central diff unconditional unstable
%
%higher order differential methods
%
%Use last temperature to update rho
%
%
%Ideal gas, coupled variables. Good approximation at surface, low density!. 1 atomic particles in hydrogen.
%Perturbation, unstable per default but system collects it self quickly. Perturbation in pressure as well? Velocity start at zero.
%
%Vertical velocity good test.
